...
const SidebarContent: MenuItem[] = [
  // ==================== NON-PRO SECTIONS ====================
  {
    heading: i18n.t('sidebar:home.title'),
    children: [
      {
        name: i18n.t('sidebar:home.dashboard'),
  ...
  {
    heading: i18n.t('sidebar:master.title'),
    children: [
      {
        name: i18n.t('sidebar:master.employee'),
      ...
      {
        name: i18n.t('sidebar:master.customer'),
        icon: 'solar:user-circle-linear',
        id: uniqueId(),
        url: '/master/customer',
        isPro: false,
